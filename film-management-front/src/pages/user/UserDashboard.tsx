                ...
                details: [
                    {
                        ...
                        quantity,
                        unitPrice: selectedFilm.ticketPrice || 10.0
                    }
                ]
            };
            ...
            <div className="p-6 bg-gray-50 min-h-screen">
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button onClick={() => { setActiveTab("tickets"); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors duration-300 flex items-center shadow-sm">
                    ...
                    <div className="bg-gradient-to-r from-red-500 to-red-700 text-white p-6 rounded-lg shadow-md mb-6">
                        <div className="flex items-start md:items-center justify-between flex-col md:flex-row gap-4">
                            ...
                            <div className="flex-shrink-0">
                                <button onClick={() => { window.scrollTo({ top: document.getElementById('movies-section')?.offsetTop || 0, behavior: 'smooth' }); }} className="px-6 py-3 bg-white text-red-600 rounded-md hover:bg-red-50 transition-colors duration-300 font-medium shadow-sm">
                                    Browse Movies
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="mb-6 border-b border-gray-200">
                        <nav className="flex space-x-8" aria-label="Tabs">
                            <button onClick={() => setActiveTab("tickets")} className={`py-4 px-1 ${activeTab === "tickets" ? "border-b-2 border-red-500 text-red-600" : "text-gray-500 hover:text-gray-700 hover:border-gray-300"} font-medium text-sm sm:text-base`}>
                                Buy Tickets & History
                            </button>
                            <button onClick={() => setActiveTab("profile")} className={`py-4 px-1 ${activeTab === "profile" ? "border-b-2 border-red-500 text-red-600" : "text-gray-500 hover:text-gray-700 hover:border-gray-300"}  font-medium text-sm sm:text-base`}>
                                Profile Settings
                            </button>
                        </nav>
                    </div>
                                ...
                                <div id="movies-section" className="bg-white rounded-lg shadow-md p-6 mb-6">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <select className="px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500" defaultValue="latest">
                                                            ...
                                                            <div key={film.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
                                                                <div className="h-48 bg-gray-200 relative">
                                                                    ...
                                                                    <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                                                                        <button onClick={() => handleBuyTicket(film)} className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors duration-300">
                                                                            Quick Buy
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                                <div className="p-4">
                                                                    ...
                                                                    <div className="flex items-center justify-between mb-2">
                                                                        <span className="text-sm text-gray-600">{genreLabels[film.genre as FilmGenre]}</span>
                                                        ...
                                                        <div className="flex justify-center mt-8">
                                                            <nav className="flex items-center space-x-2" aria-label="Pagination">
                                                                <button
                                                                    ...
                                                                    className={`px-3 py-2 rounded-md ${currentPage === 0
                                                                ...
                                                                {[...Array(totalPages)].map((_, i) => (
                                                                    <button
                                                                        ...
                                                                        className={`px-3 py-2 rounded-md ${i === currentPage
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`px-3 py-2 rounded-md ${currentPage === totalPages - 1
                                                                            ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                                                                            : "bg-white text-gray-700 hover:bg-gray-50 border border-gray-300"
                                                                        }`}
                                                                >
                                ...
                                <div className="flex items-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center text-sm text-gray-600 mt-1">
                                            <span className="mr-3">{genreLabels[selectedFilm.genre as FilmGenre]}</span>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="grid grid-cols-3 gap-3">
                                            <div
                                                ...
                                                className={`p-3 border rounded-md cursor-pointer text-center transition-colors duration-200 ${paymentMethod === PaymentMethod.CREDIT_CARD
                                            ...
                                            <div
                                                ...
                                                className={`p-3 border rounded-md cursor-pointer text-center transition-colors duration-200 ${paymentMethod === PaymentMethod.PSE
                                                        ? "border-red-500 bg-red-50"
                                                        : "border-gray-300 hover:bg-gray-50"
                                                    }`}
                                            >
                                            ...
                                            <div
                                                ...
                                                className={`p-3 border rounded-md cursor-pointer text-center transition-colors duration-200 ${paymentMethod === PaymentMethod.CASH
                                                        ? "border-red-500 bg-red-50"
                                                        : "border-gray-300 hover:bg-gray-50"
                                                    }`}
                                            >
