...
import { Dashboard, FilmForm, FilmsManagement, Login, NotFound, PurchasesManagement, Register, Unauthorized, UserForm, UsersManagement } from "../pages";
            ...
            <AuthProvider>
                <Routes>
                    ...
                    <Route element={ <ProtectedRoute allowedRoles={["ADMIN"]} /> }>
                        <Route path="/admin/purchases" element={ <PurchasesManagement/> } />
